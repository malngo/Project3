...
var margin = {top: 20, right: 100, bottom: 30, left: 80}, //margins to make sure everything is on screen
 ...
 // });
  ...
  svg.append("g")
    ...
    .append("text")
      ...
      .attr("x", 200) //changed to x from y
...
//datum-If you want to bind your data to multiple SVG elements
  country.append("text") //adds country text to the end line chart
